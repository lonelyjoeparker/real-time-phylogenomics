...
# other
BLAST_DB_THALIANA_REFERENCE=/media/joe/BiSlDi/genomes/Arabidopsis_thaliana/A_thaliana
BLAST_DB_LYRATA_REFERENCE=/media/joe/BiSlDi/genomes/Arabidopsis_both_ssp_merged/A_lyrata_ssp
...
# 1. Blast ONT reads:
#	1a ONT thaliana vs DB thaliana (TP)
$BLASTN -db $BLAST_DB_THALIANA_REFERENCE -query $READS_ONT_THALIANA  -num_threads 8 -evalue 1.0 -outfmt "6 qacc length pident evalue" -max_target_seqs 1  -max_hsps 1 > $BLAST_OUT/1a_type-pores_db-thaliana-REFERENCE_query-thaliana.out
#	1b ONT tliana vs DB lyrata (FP)
$BLASTN -db $BLAST_DB_LYRATA_REFERENCE -query $READS_ONT_THALIANA  -num_threads 8 -evalue 1.0 -outfmt "6 qacc length pident evalue" -max_target_seqs 1  -max_hsps 1 > $BLAST_OUT/1b_type-pores_db-lyrata-REFERENCE_query-thaliana.out
#	1c ONT lyrata vs DB thaliana (TP)
$BLASTN -db $BLAST_DB_THALIANA_REFERENCE -query $READS_ONT_LYRATA  -num_threads 8 -evalue 1.0 -outfmt "6 qacc length pident evalue" -max_target_seqs 1  -max_hsps 1 > $BLAST_OUT/1c_type-pores_db-thaliana-REFERENCE_query-lyrata.out
#	1d ONT lyrata vs DB lyrata (FP)
$BLASTN -db $BLAST_DB_LYRATA_REFERENCE -query $READS_ONT_LYRATA  -num_threads 8 -evalue 1.0 -outfmt "6 qacc length pident evalue" -max_target_seqs 1  -max_hsps 1 > $BLAST_OUT/1d_type-pores_db-lyrata-REFERENCE_query-lyrata.out

# 2. Blast MiSeq reads:
#	2a MiSeq thaliana vs DB thaliana (TP)
$BLASTN -db $BLAST_DB_THALIANA_REFERENCE -query $READS_MISEQ_THALIANA  -num_threads 8 -evalue 1.0 -outfmt "6 qacc length pident evalue" -max_target_seqs 1  -max_hsps 1 > $BLAST_OUT/2a_type-miseq_db-thaliana-REFERENCE_query-thaliana.out
#	2b MiSeq thaliana vs DB lyrata (FP)
$BLASTN -db $BLAST_DB_LYRATA_REFERENCE -query $READS_MISEQ_THALIANA  -num_threads 8 -evalue 1.0 -outfmt "6 qacc length pident evalue" -max_target_seqs 1  -max_hsps 1 > $BLAST_OUT/2b_type-miseq_db-lyrata-REFERENCE_query-thaliana.out
#	2c MiSeq lyrata vs DB thaliana (TP)
$BLASTN -db $BLAST_DB_THALIANA_REFERENCE -query $READS_MISEQ_LYRATA  -num_threads 8 -evalue 1.0 -outfmt "6 qacc length pident evalue" -max_target_seqs 1  -max_hsps 1 > $BLAST_OUT/2c_type-miseq_db-thaliana-REFERENCE_query-lyrata.out
#	2d MiSeq lyrata vs DB lyrata (FP)
$BLASTN -db $BLAST_DB_LYRATA_REFERENCE -query $READS_MISEQ_LYRATA  -num_threads 8 -evalue 1.0 -outfmt "6 qacc length pident evalue" -max_target_seqs 1  -max_hsps 1 > $BLAST_OUT/2d_type-miseq_db-lyrata-REFERENCE_query-lyrata.out

# 3. Pairwise comparisons - ONT
#	3a ONT thaliana, TP (thaliana)(1a) vs FP (lyrata)(1b)
$COMPARE_BLAST $BLAST_OUT/1a_type-pores_db-thaliana-REFERENCE_query-thaliana.out $BLAST_OUT/1b_type-pores_db-lyrata-REFERENCE_query-thaliana.out > $BLAST_OUT/pairwise_REFERENCE_type-pores_tp-thaliana_fp-lyrata.out 2> $BLAST_OUT/pairwise_REFERENCE_type-pores_tp-thaliana_fp-lyrata.out.summary
#	3b ONT lyrata, TP (lyrata)(1d) vs FP (thaliana)(1c)
$COMPARE_BLAST $BLAST_OUT/1d_type-pores_db-lyrata-REFERENCE_query-lyrata.out $BLAST_OUT/1c_type-pores_db-thaliana-REFERENCE_query-lyrata.out > $BLAST_OUT/pairwise_REFERENCE_type-pores_tp-lyrata_fp-thaliana.out 2> $BLAST_OUT/pairwise_REFERENCE_type-pores_tp-lyrata_fp-thaliana.out.summary

# 4. Pairwise comparisons - MiSeq
#	4a MiSeq thaliana, TP (thaliana)(2a) vs FP (lyrata)(2b)
$COMPARE_BLAST $BLAST_OUT/2a_type-miseq_db-thaliana-REFERENCE_query-thaliana.out $BLAST_OUT/2b_type-miseq_db-lyrata-REFERENCE_query-thaliana.out > $BLAST_OUT/pairwise_REFERENCE_type-miseq_tp-thaliana_fp-lyrata.out 2> $BLAST_OUT/pairwise_REFERENCE_type-miseq_tp-thaliana_fp-lyrata.out.summary
#	4b MiSeq lyrata, TP (lyrata)(2d) vs FP (thaliana)(2c)
$COMPARE_BLAST $BLAST_OUT/2d_type-miseq_db-lyrata-REFERENCE_query-lyrata.out $BLAST_OUT/2c_type-miseq_db-thaliana-REFERENCE_query-lyrata.out > $BLAST_OUT/pairwise_REFERENCE_type-miseq_tp-lyrata_fp-thaliana.out 2> $BLAST_OUT/pairwise_REFERENCE_type-miseq_tp-lyrata_fp-thaliana.out.summary
